...
export class MilkContainer extends React.Component {



  componentWillMount(){
    const url = 'http://localhost:8080/milk'
  ...
  return(
    ...
    <div>
      <Milk products={this.props.products} addCartAction={this.props.addCartAction}
...
export default connect(mapStateToProps,{fetchProducts,addCartAction,removeCartAction})(MilkContainer)
