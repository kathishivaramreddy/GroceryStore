...
export class TeaContainer extends React.Component {



  componentWillMount(){
    const url = 'http://localhost:8080/tea'
  ...
  return(
    ...
    <div>
      <Tea products={this.props.products} addCartAction={this.props.addCartAction}
...
export default connect(mapStateToProps,{fetchProducts,addCartAction,removeCartAction})(TeaContainer)
